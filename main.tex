...
% \usepackage{txfonts}
% \usepackage{bbold}
\usepackage[font=tiny,skip=1pt]{caption}
...
\setbeamertemplate{section in toc}{\hspace*{8em}\inserttocsection}
\setbeamertemplate{subsection in toc}{\small\hspace*{13.2em}\inserttocsubsection}
    ...
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                ...
                \vtop{\includegraphics[width=\linewidth]{4.1}}
    ...
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                ...
                \vtop{\includegraphics[width=\linewidth]{4.3}}
                \column{0.7\linewidth}
                \vtop{\begin{itemize}{\leftmargin=0em \itemindent=0em}
                    \item<3-> In 2D, consider a point $P$ of the triangulation.
                    \item<4-> Let angles at $P$ of triangles be $\theta_\mathtt{t}$. We know,
                    \begin{equation}
                        \cos{\theta_\mathtt{t}}=\frac{c^2-a^2-b^2}{2ab}\,.
                    \end{equation}
                    \item<5-> If the angles around $P$ sum up to $2\pi$, the manifold is flat at $P$. The Regge curvature at $P$ can be defined as the \italictext{deficit angle},
                    \begin{equation}
    ...
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                ...
                \vtop{\includegraphics[width=\linewidth]{4.4}\label{fig:4.4}}
                \column{0.75\linewidth}
                \vtop{In higher dimensions, the Regge curvature is still given by a single deficit angle. $P$ is replaced by a $(d-2)$-simplex (a segment in 3D and a triangle in 4D). The sum is over the (pairs of) $(d-1)$-simplices around it (triangles in 3D and tetrahedra in 4D).}
            \end{columns}
        \end{minipage}
        \item<2->[] \hfill
        \item<2-> \noindent
        \begin{minipage}{\linewidth}
            \begin{columns}
                ...
                \end{equation}
                \column{0.3\linewidth}
                \vtop{\includegraphics[width=\linewidth]{4.5}}
            \end{columns}
...
\begin{frame}{Discretization of general relativity}
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                \column{0.3\linewidth}
                \vtop{\includegraphics[width=\linewidth]{4.6}}
                \column{0.7\linewidth}
                \vtop{\begin{itemize}{\leftmargin=0em \itemindent=0em}
    ...
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}\centering
            \begin{columns}\centering
                \column{0.56375\linewidth}
                \vtop{\begin{figure}
                    \includegraphics[width=\linewidth]{4.7}
                    \caption{In 3D}
                \end{figure}}
                % \centering In 3D
                \column{0.43625\linewidth}\centering
                \vtop{\begin{figure}
    ...
    \begin{minipage}{\linewidth}\centering
        \begin{columns}\centering
            ...
            \begin{itemize}
                ...
                \end{equation*}
            \end{itemize}}
            \column{0.505\linewidth}\centering
    ...
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                ...
                \vtop{\includegraphics[width=\linewidth]{4.10}}
                \column{0.65\linewidth}
                \vtop{Analogous to eq. \ref{u_f}, we can associate a single group element $U_\mathtt{f}$ with a face $\mathtt{f}$ bounded by edges $\mathtt{e}_1,\dots,\mathtt{e}_n$,
                \begin{equation}
    ...
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                ...
                \vtop{\includegraphics[width=\linewidth]{4.11}}
                \column{0.85\linewidth}
                \vtop{With spins $j_1,j_2,j_3$ coming out from node $\mathtt{n}$, grouping together the Hilbert spaces next to the same node, we have,
                \begin{equation}
...
\begin{frame}{Alternative form of the transition amplitude}
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \begin{minipage}{\linewidth}
            \begin{columns}
                \column{0.25\linewidth}
                \vtop{\includegraphics[width=\linewidth]{4.12}}
                \column{0.75\linewidth}
                \vtop{Introducing two variables per link $\ell$, associated with each vertex-edge couple, such that $U_\mathtt{e}=g_{\mathtt{ve}}g_{\mathtt{ev'}}$ and $g_{\mathtt{ve}}=g^{-1}_{\mathtt{ev}}$, we can write,
                \begin{equation}
...
\begin{frame}{Alternative form of transition amplitudes}
    \begin{list}{\maltese}{\leftmargin=1em \itemindent=0em}
        ...
        \end{equation*}
        The trace runs around a face and is called the \italictext{face amplitude}. 
        \item<2-> \noindent
        \begin{minipage}{\linewidth}
            \begin{columns}
                \column{0.75\linewidth}
                \vtop{The \italictext{wedge amplitude} is defined by,
                \begin{equation*}
                    W(g,h)=\sum_j(2j+1)\mathbf{Tr}_{j}[Y_\gamma^\dagger g Y_\gamma h]\,.
                \end{equation*}}
                \column{0.25\linewidth}
                \vtop{\includegraphics[width=\linewidth]{4.13}}
            \end{columns}
        \end{minipage}
